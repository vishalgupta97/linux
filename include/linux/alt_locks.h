...
#define alt_rwsem_assert_held(lock) 		
#define alt_rwsem_assert_held_write(lock) 	
#define alt_init_rwsem 			percpu_init_rwsem
#define alt_down_write_nested		percpu_down_write_nested
#define alt_down_write_killable		percpu_down_write
...
#define alt_down_read_killable		percpu_down_read
...
#define alt_rwsem_is_contended		percpu_is_write_locked
